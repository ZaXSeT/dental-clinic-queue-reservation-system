        ...
        <main className="h-screen max-h-screen bg-slate-50 text-slate-800 overflow-hidden flex flex-col">
            <header className="bg-white/80 backdrop-blur-md px-10 py-6 flex justify-between items-center shadow-sm z-10">
                <div className="flex items-center gap-6">
                    ...
                    {!isAdmin && (
                        <Link href="staff/portal/dashboard" className="p-3 rounded-full bg-slate-100/80 hover:bg-slate-200 text-slate-500 hover:text-slate-900 transition-all border border-slate-200 hover:shadow-md group" aria-label="Back">

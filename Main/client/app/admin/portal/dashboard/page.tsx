...
export default async function Dashboard() {
    ...
    const stats = [
        { label: "Patients (Total)", val: patientCount.toString(), icon: Users, color: "bg-blue-500", href: "/staff/portal/patients" },
        { label: "Today's Appointments", val: appointmentCount.toString(), icon: Calendar, color: "bg-purple-500", href: "/staff/portal/appointments" },
        { label: "In Queue (Waiting)", val: waitingCount.toString(), icon: Clock, color: "bg-orange-500", href: "/staff/portal/queue" },
    ];
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
                <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-white/50 backdrop-blur-sm">
                    ...
                    <Link href="/staff/portal/queue" className="px-4 py-2 bg-slate-50 text-slate-600 rounded-lg text-sm font-semibold hover:bg-slate-100 hover:text-slate-900 transition-colors border border-slate-200">
                        View Full Queue
                    </Link>
                </div>

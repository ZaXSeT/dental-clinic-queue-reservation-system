                                            ...
                                            return (
                                                <div key={idx} className="p-2 border-l border-slate-50 flex flex-col gap-2 items-center justify-start py-4">
                                                    {slots.length > 0 ? slots.map((time) => {
                                                        ...
                                                        const isPassed = day.fullDate === todayStr && slotToMinutes(time) < currentMinutes;
                                                        
                                                        const isBooked = dentist.bookedSlots?.some(slot => {
                                                            ...
                                                            return slotDateStr === day.fullDate && slot.time === time;
                                                        });
                                                        ...
                                                        return (
                                                            <button
                                                                key={time}
                                                                disabled={isDisabled}
                                                                onClick={() => !isDisabled && onBooking(dentist.id, day.fullDate, time)}
                                                                className={`
                                                            ...
                                                            `}
                                                            >
                                                                {isBooked ? 'Filled' : isPassed ? 'Passed' : time}
                                                            </button>
                                                        );
